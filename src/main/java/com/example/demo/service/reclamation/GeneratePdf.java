...
public class GeneratePdf {
	...
	public static ByteArrayInputStream Report(List<Reclamation> list) throws MalformedURLException, IOException {
		...
		try {
			...
			// Add Text to PDF file ->
						...
						Paragraph para = new Paragraph( "Liste des Reclamation", font);
						para.setAlignment(Element.ALIGN_CENTER);
						document.add(para);
						document.add(Chunk.NEWLINE);
			        	
			        	PdfPTable table = new PdfPTable(5);
						Stream.of("ID", "Content", "Produit","Date de creation","User")
						    .forEach(headerTitle -> {
			            ...
			            for (Reclamation recl : list) {
			            	PdfPCell idCell = new PdfPCell(new Phrase(String.valueOf(recl.getId())));
			            	idCell.setPaddingLeft(4);
			            	idCell.setVerticalAlignment(Element.ALIGN_MIDDLE);
			            	idCell.setHorizontalAlignment(Element.ALIGN_CENTER);
			                table.addCell(idCell);

			                PdfPCell nomPrenomCell = new PdfPCell(new Phrase(recl.getContent()));
			                ...
			                PdfPCell montantCell = new PdfPCell(new Phrase(String.valueOf(recl.getProduit().getLibelle())));
			                ...
			                PdfPCell montantRemiseCell = new PdfPCell(new Phrase(String.valueOf(recl.getCreatedAt())));
